...
def nonlinear_model(rod_nl):
    ...
    rod_nl.k2[np.abs(rod_nl.k2)<=rod_nl.eps]=rod_nl.eps # ensure non zero values for curvature so no division by zero
    rod_nl.f3 = -(rod_nl.F1 + rod_nl.E * rod_nl.I * np.flip(odesol.y[2, :])) / rod_nl.k2
...
def mat_nonlinear_model(rod_nl):
    ...
    E0=[rod_nl.Q/rod_nl.E/rod_nl.I,rod_nl.P,rod_nl.Nf] # boundary conditions
